...
void BaseShader::loadVertexShader(const wchar_t* filename)
{
	...
	rendererDevice->CreateVertexShader(vertexShaderBuffer->GetBufferPointer(), vertexShaderBuffer->GetBufferSize(), NULL, &vertexShader);
	...
	rendererDevice->CreateInputLayout(polygonLayout, numElements, vertexShaderBuffer->GetBufferPointer(), vertexShaderBuffer->GetBufferSize(), &layout);
...
void BaseShader::loadPixelShader(const wchar_t* filename)
{
	...
	rendererDevice->CreatePixelShader(pixelShaderBuffer->GetBufferPointer(), pixelShaderBuffer->GetBufferSize(), NULL, &pixelShader);
...
void BaseShader::loadHullShader(const wchar_t* filename)
{
	...
	rendererDevice->CreateHullShader(hullShaderBuffer->GetBufferPointer(), hullShaderBuffer->GetBufferSize(), NULL, &hullShader);
...
void BaseShader::loadDomainShader(const wchar_t* filename)
{
	...
	rendererDevice->CreateDomainShader(domainShaderBuffer->GetBufferPointer(), domainShaderBuffer->GetBufferSize(), NULL, &domainShader);
...
void BaseShader::loadGeometryShader(const wchar_t* filename)
{
	...
	// Create the domain shader from the buffer.
	rendererDevice->CreateGeometryShader(geometryShaderBuffer->GetBufferPointer(), geometryShaderBuffer->GetBufferSize(), NULL, &geometryShader);
...
void BaseShader::loadComputeShader(const wchar_t* filename)
{
	...
	// Create the domain shader from the buffer.
	rendererDevice->CreateComputeShader(computeShaderBuffer->GetBufferPointer(), computeShaderBuffer->GetBufferSize(), NULL, &computeShader);
